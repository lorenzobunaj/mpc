from ..OT_M_extension.protocol.wrapper import OT_m_protocol
from ..OT_M_extension.primitives import PRG, CR_HASH
from ..OT_M_extension.oracles import KOT
import os
...
def protocol_test():
    ...
    for i in range(10):
        ...
        real_results = OT_m_protocol(K, l, n, m, S_inputs, R_inputs, KOT, PRG, CR_HASH)
