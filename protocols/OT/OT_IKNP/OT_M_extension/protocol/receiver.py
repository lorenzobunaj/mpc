...
class Receiver:
    ...
    def send_U(self, PRG):
        ...
        tau = [int.from_bytes(os.urandom(1), byteorder="big") % 2 for _ in range(self.r)]
    ...
    def consistency_check(self, PRG, CR_HASH):
        ...
        for a in range(self.l):
            ...
            for b in range(self.l):
                H.append([])
                H[a][b].append(CR_HASH(a, xor(self.m + self.r, PRG(self.KOT_seeds[a][0]), PRG(self.KOT_seeds[b][0]))))
                H[a][b].append(CR_HASH(a, xor(self.m + self.r, PRG(self.KOT_seeds[a][0]), PRG(self.KOT_seeds[b][1]))))
                H[a][b].append(CR_HASH(a, xor(self.m + self.r, PRG(self.KOT_seeds[a][1]), PRG(self.KOT_seeds[b][0]))))
                H[a][b].append(CR_HASH(a, xor(self.m + self.r, PRG(self.KOT_seeds[a][1]), PRG(self.KOT_seeds[b][1]))))
