...
class Sender:
    ...
    def KOT_send(self):
        ...
        print("KOT choice bits 0 and 1: ")
        print(self.KOT_choice_bits[0])
        print(self.KOT_choice_bits[1])
    ...
    def KOT_receive(self, KOT_choosen_seeds):
        ...
        print("KOT seeds 0 and 1: ")
        print(self.KOT_choosen_seeds[0])
        print(self.KOT_choosen_seeds[1])
    ...
    def consistency_check(self, H, PRG, CR_HASH):
        ...
        for a in range(self.l):
            ...
            for b in range(a, self.l):
                hashes[a].append(CR_HASH(a, xor(self.m + self.r, PRG(self.KOT_choosen_seeds[a], self.m + self.r), PRG(self.KOT_choosen_seeds[b], self.m + self.r)), self.m + self.r))
                hashes_hat[a].append(CR_HASH(a, xor(self.m + self.r, PRG(self.KOT_choosen_seeds[a], self.m + self.r), PRG(self.KOT_choosen_seeds[b], self.m + self.r), self.U[a], self.U[b]), self.m + self.r))
